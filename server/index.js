      ...
      for (const { url, source, keyword } of urls) {
        try {
          ...
          if (response.status === 200) {
            ...
            // Lógica de parsing de exemplo para 'folha'
          ...
          console.error(`Error fetching results for keyword: ${kw}, source: ${source}`, error.message);
        }
      }
    }
...
const PARENT_FOLDER_ID = '1R2B5kRHwh0xl6hBV6tLh7eOHne1stCXl';
